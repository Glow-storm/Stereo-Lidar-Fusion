...
left_image = cv2.imread(r"D:/dataspell project/FinalYearProject/FinalYearProject/our_dataset/left_img/left_rect_1.015734.png", cv2.IMREAD_GRAYSCALE)
print(left_image.shape)
right_image = cv2.imread(r"D:/dataspell project/FinalYearProject/FinalYearProject/our_dataset/right_img/right_rect_1.015734.png", cv2.IMREAD_GRAYSCALE)
...
while True:
    if cv2.getWindowProperty("disp", cv2.WND_PROP_VISIBLE) >= 0:
        ...
        stereo3=cv2.StereoSGBM_create(minDisparity=0, numDisparities=80, blockSize=(1*(2+5)),P1=8*3*(1*(2+5))**2,P2=32*3*(1*(2+5))**2 ,disp12MaxDiff=8, uniquenessRatio=10, speckleWindowSize=2, speckleRange=13, preFilterCap=5,  mode=cv2.STEREO_SGBM_MODE_SGBM_3WAY)
    ...
    if cv2.waitKey(1) == 27:
        ...
        cv2.imwrite(r"D:\dataspell project\FinalYearProject\FinalYearProject\our_dataset\depth maps\img1.png",depth_uint16)
        break
